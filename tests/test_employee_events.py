...
@pytest.fixture
def db_path():
    """Return the employee-events database path used by the package."""
...
def test_db_exists(db_path):
    """Confirm the project database is included."""
...
def test_employee_table_exists(table_names):
    """Confirm the employee table exists."""
...
def test_employee_events_table_exists(table_names):
    """Confirm the employee-events table exists."""
